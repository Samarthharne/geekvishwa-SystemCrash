    ...
    var __webpack_modules__ = {
            ...
            44: function(n, t, e) {
                n.exports = function() {
                    ...
                    function Z(n, t) {
                        this._instanceConstructor = n, this.promise = new n(R), this.promise[S] || Q(this.promise), i(t) ? (this._input = t, this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? j(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(), 0 === this._remaining && j(this.promise, this._result))) : G(this.promise, nn())
                    }
            ...
            8821: function(n, t, e) {
                ...
                function sn() {
                    var n = null;
                    i.isNumber(n) && 0 === Y.getCount() ? (R.log("Activating after delay of", n, "ms because no Experiments are running"), I.dispatch(c.SET_RUM_DATA, {
                        data: {
                            activateDfd: !0
                        }
                ...
                function vn(n, e, r, o) {
                    try {
                        var a = function(n) {
                            ...
                            u = p.decideGroup(o, a);
                        if (u.reason) return R.debug("Not activating Group", A.description(o), "; reason:", u.reason), J.getSampleRum() && I.dispatch(c.RECORD_LAYER_FEATURE_USAGE, {
                            feature: "mutex",
                            entityId: o.id
                        }), O.resolve();
                        var s = Y.get(u.layerId);
                        if (!s) return R.debug("Visitor was bucketed into a Campaign (" + u.layerId + ") which is not in this snippet"), O.resolve();
                        var f = i.filter(s.pageIds, i.partial(i.includes, r));
                        return i.isEmpty(f) ? (R.debug("Not activating Group", A.description(o), "; reason: visitor was bucketed into a Campaign/Experiment not related to the currently-activating Page(s)"), O.resolve()) : (J.getSampleRum() && I.dispatch(c.RECORD_LAYER_FEATURE_USAGE, {
                            feature: "mutex",
                            entityId: o.id
                        }), t.decideAndExecuteLayerASAP(n, e, f, s))
                    } catch (l) {
                        return R.error("Error getting decision for Group", A.description(o), "; ", l), O.reject(l)
                    }
                }
                ...
                t.initialize = function(n) {
                    ...
                    if (i.isArray(window.optimizely) && (window.optimizely = i.filter(window.optimizely, (function(n) {
                        ...
                        if (i.isFunction(e)) try {
                            ...
                            R.error("Error while executing projectJS: ", v), d.emitError(new a(v))
                        }
                        ...
                        var r = y.on({
                            ...
                            handler: function() {
                                Q.observe(F.persistVisitorProfile), K.observe(F.persistLayerStates), z.observe(F.persistSessionState), W.observe(k.persistPendingEvents), en.observe(F.persistVisitorBucketingStore), y.off(r)
                            }
                        });
                        y.on({
                            filter: {
                    ...
                    try {
                        ...
                        var r = dn(),
                            o = p.decideGlobal(r);
                        R.log("Made global decision", r, "->", o), I.dispatch(c.RECORD_GLOBAL_DECISION, o);
                        var a = s.trackClientActivation();
                        a ? R.log("Tracked activation event", a) : R.log("Not tracking activation event");
                    ...
                    try {
                        ...
                        var a = function(n) {
                            var e = Y.getAllByPageIds(n),
                                ...
                                a = !i.isEmpty(r);
                            a && R.log("Force variations are in use. Disabling mutual exclusivity.");
                            var u = a ? {
                                individual: e
                            ...
                            R.log("Campaigns/Experiments not in Groups (by Campaign id):", s);
                            ...
                            return O.all(d).then((function(t) {
                                ...
                                return R.log("All Campaigns/Experiments for Page(s) (by Campaign id)", n, "resolved:", i.map(e, T.description).join(", ")), e
                            }))
                        }(o)["catch"](d.emitError);
                        return e = O.all(i.map(r, (function(n) {
                            var t = function() {
                                ...
                                t ? R.log("Tracked activation for Page", V.description(n), t) : R.log("Not Tracking activation for Page", V.description(n))
                            };
                    ...
                    i.each(e, (function(n) {
                        ...
                        e && (i.each(e, (function(n, e) {
                            if (n.cancel) try {
                                n.cancel(), R.debug("Controller / Canceled change", e, "observation due to deactivation of page:", t)
                            } catch (i) {
                                R.error("Controller / Error canceling change", e, "observation upon deactivation of page.", i)
                            }
                            if (t.undoOnDeactivation && n.undo) try {
                                n.undo(), R.debug("Controller / Undid change", e, "due to deactivation of page:", t)
                            } catch (r) {
                                R.error("Controller / Error undoing change upon deactivation of page.", r)
                            }
                        })), I.dispatch(c.REMOVE_ACTION_STATE, {
                            actionId: n
                        }), R.debug("Controller / Undid changes and/or canceled change observation due to deactivation of page:", t, n))
                    }))
                    ...
                    var n = e(7581),
                        r = !!F.getCurrentId(),
                        o = !!r && F.hasSomeData();
                    r ? o ? R.log("xd / Existing visitor; has data on this origin") : R.log("xd / Existing visitor; new to this origin") : R.log("xd / New visitor");
                    var a = H.getAccountId(),
                        u = "https://a5465611416.cdn.optimizely.com".replace("__SUBDOMAIN__", "a" + a + "."),
                    ...
                    var l = n.fetchAll().then((function(t) {
                        if (!tn.getVisitorIdLocator()) {
                            ...
                            if (e) {
                                ...
                                i && (R.log("Syncing cross-origin visitor randomId:", i), F.maybePersistVisitorId({
                                    randomId: i
                                }))
                            }
                        }
                        ...
                        R.log("Loaded visitor data from foreign origins"), f.emitOriginsSyncedEvent()
                    }), (function(n) {
                        throw r && !o && (R.debug("xd / Failed to load foreign data:", n), ln(!1, n)), n
                    }));
                    return O.all([n.load(u, s)["catch"]((function(n) {
                        throw R.debug("xd / Failed to load iframe:", n), r && !o && ln(!1, n), n
                    })), l["catch"]((function(n) {
                        R.debug("xd / Ignored error syncing foreign data (expected if waitForOriginSync used):", n.message), R.debug("xd / Enqueuing sync to happen after visitorId set."), I.dispatch(c.ADD_CLEANUP_FN, {
                    ...
                    return new O((function(a, d) {
                        try {
                            ! function(n, t, e, r, o) {
                                ...
                                if (J.getSampleRum()) {
                                    ...
                                    O.race([c, new O((function(n, t) {
                                        ...
                                        R.log("Activating Campaign after pending Audiences resolved", n), r()
                                    }), (function() {
                                        R.log("Activating Campaign after timeout on Audiences", n), r()
                                    }))
                                    ...
                                    i.map(t, (function(t) {
                                        ! function(n, t, e) {
                                            ...
                                            R.log("When deciding Campaign", T.description(e), "visitor is in audiences:", pn(r), "and not in audiences:", pn(o))
                                        }(t, u, n)
                                    })), o(t)
                                }))
                            }(o, n, e, r, (function(l) {
                                i.each(l, (function(a) {
                                    ...
                                    R.debug("Deciding layer: ", o, "with decisionTicket: ", a, "and actionViewIds: ", l),
                                        function(n, e, r, o, a) {
                                            var l = T.description(n);
                                            R.log("Activating Campaign", l, "on Page(s)", o), r.length && (R.log("Applying force audienceIds:", r, "to Campaign", l), (a = i.cloneDeep(a)).audienceIds = r);
                                            ...
                                            if (h.maybeExecute && function(n, t, e, r) {
                                                    ...
                                                    R.log("Preparing actions", n, "for Campaign", o, "on Page(s)", r), i.forEach(n, u.prepareAction)
                                            ...
                                            if (!p.isInCohort(d)) return void R.log("Not activating Campaign: " + T.description(n) + "; not in the cohort because:", d.reason);
                                            h.maybeExecute && function(n, t, e, r) {
                                                var o = T.description(t);
                                                R.log("Executing actions", n, "for Campaign", o, "on Page(s)", r), O.all(i.map(n, (function(n) {
                                                    return u.executePreparedAction(n).then(i.partial(f.emitActionAppliedEvent, n))
                                                }))).then((function() {
                                                    R.log("All page actions for", e, "applied:", n), f.emitActionsForDecisionAppliedEvent(e, n)
                                                }))["catch"]((function(n) {
                                                    R.warn("Error evaluating page actions for decision", e, "because:", n)
                                                }))
                                            }(g, n, d, o)
                                        }(o, n, e, l, a)
                                })), a(o)
                            ...
                            R.error("Error getting decision for Campaign: " + T.description(o), v), d(v)
                        }
                    }))
                }, t.decideLayer = function(n, t, e) {
                    var i;
                    var r = T.description(n);
                    i = e.length ? p.getDummyLayerDecision(n, e) : p.decideLayer(n, t), R.log("Recording decision for Campaign", r, t, "->", i), T.recordLayerDecision(n.id, t, i), i.variationId && i.experimentId && F.updateVariationIdMap(n.id, i.experimentId, i.variationId), n.groupId && F.updatePreferredLayerMap(n.groupId, n.id);
                    return i
                    ...
                    if (o.actions = [].concat(G.getLayerActions(t.layerId) || [], G.getExperimentActions(t.experimentId) || [], G.getExperimentVariationActions(t.experimentId, t.variationId) || []), !e && H.isGlobalHoldback()) return R.log(r, i, "(visitor is in global holdback)"), o;
                    if (t.isLayerHoldback) return R.log(r, i, "(visitor is in layer holdback)"), o;
                    if (!t.experimentId || !t.variationId) return R.log(r, i, "(visitor is not eligible for any Experiments)"), o;
                    return o.maybeExecute = !0, R.log("Got Actions for Campaign:", i, o.actions), o
                }
            },
            2174: function(n, t, e) {
                var i = e(44).Promise,
                                ...
                                if (u.src) {
                                    var h = "change_" + u.src,
                                        m = a.makeAsyncRequest(h, (function() {
                                            return v.addScriptAsync("https://cdn.optimizely.com/public/5465611416/data" + u.src, (function() {
                                                a.resolveRequest(h)
                                            }))
                                        })).then((function() {
            ...
            9314: function(n, t, e) {
                ...
                t.initialize = function(n, t) {
                    ...
                    var e = !1,
                        i = n[0] || t[0];
                    return _.EVENTBASE in i ? (w(f.C(n)), b(f.C(t))) : (e = !0, w(f.O(n)), b(f.O(t))), T().length > 0 && (R(), e = !0), w(f._updateBaseMapAndMaybeDedupe(I())), f._migrateEventBasesAndUpdateStore() && (e = !0), e
                }, f.O = function(n) {
                ...
                n.exports = {
                    initialize: function() {
                        this.X = {
                            ...
                            autoRefresh: true
                        }, this.on(i.SET_COOKIE_DOMAIN, this.Tn), this.on(i.SET_COOKIE_AGE, this.Sn), this.on(i.SET_COOKIE_AUTO_REFRESH, this.Rn)
                    },
                            ...
                            if (!(e.integrationStringVersion && 2 === e.integrationStringVersion && a.isSingleExperimentPolicy(n.layerPolicy) && r)) return function(n, t, e, r) {
                                return (s = 50, h = 200, u.pollFor((function() {
                                    ...
                                    ! function(n, t) {
                                        ...
                                        return s
                                    }(s.names, s.idStrings, r, v, n.policy)),
                                    function(n, t, e) {
                                        var i, r, u;
            ...
            2628: function(n, t, e) {
                ...
                n.exports = function(n) {
                    n.registerViewMatcher("custom_code", r)
                }
            },
            414: function(n, t, e) {
                n.exports = function(n) {
        ...
        try {
            ! function() {
                var n = function(n) {
                    ...
                    t.push(__webpack_require__(1569)), t.push(__webpack_require__(6879)), t.push(__webpack_require__(9754)), t.push(__webpack_require__(9374)), t.push(__webpack_require__(5664)), t.push(__webpack_require__(6093)), t.push(__webpack_require__(9031)), t.push(__webpack_require__(8068)), t.push(__webpack_require__(520)), t.push(__webpack_require__(9665)), t.push(__webpack_require__(928)), t.push(__webpack_require__(186)), t.push(__webpack_require__(1310)), t.push(__webpack_require__(3056)), t.push(__webpack_require__(4409)), t.push(__webpack_require__(2774)), t.push(__webpack_require__(414)), t.push(__webpack_require__(2628)), t.push(__webpack_require__(7154)), t.push(__webpack_require__(7649)), t.push(__webpack_require__(9026)), t.push(__webpack_require__(4870)), f.initializePlugins(t)
                };
                ...
                var o, a = __webpack_require__(6072),
                    ...
                    s = {
                        "accountId": "5465611416",
                        "namespace": "5465611416",
                        "revision": "13688",
                        "anonymizeIP": false,
                        ...
                        "projectId": "5465611416",
                        "layers": [{
                            "changes": null,
                            "id": "25742550012",
                            "name": "Pricing Comparison Chat Bot",
                            "commitId": "25791150761",
                            "groupId": null,
                            "holdback": 0,
                            "activation": {},
                            "integrationSettings": {
                                "google_universal_analytics": {
                                    "universal_analytics_slot": "20",
                            ...
                            "experiments": [{
                                "audienceIds": ["and", "20901740234", "7339090092"],
                                "audienceName": "Exclude Subscriber Cookie (for New User),Desktop (Mobile Excluded)",
                                "changes": null,
                                "id": "25683641033",
                                ...
                                "variations": [{
                                    ...
                                    "actions": [{
                                        "viewId": "25682000707",
                                        "changes": [{
                                            "id": "B05E1099-5BCB-4301-A2EB-D232B6FBDD07",
                                            "type": "custom_code",
                                            "value": function($) {
                                                ...
                                                // We pre-filled your app ID in the widget URL: 'https://widget.intercom.io/widget/suxs1bg1'
                                                (function() {
                                                    var w = window;
                                                    var ic = w.Intercom;
                                                    if (typeof ic === "function") {
                                                        ...
                                                        var l = function() {
                                                            ...
                                                            s.async = true;
                                                            s.src = 'https://widget.intercom.io/widget/suxs1bg1';
                                        ...
                                        "viewId": "25701110939",
                                        "changes": [{
                                            "id": "5CEC3AFA-AF59-413A-A635-DF7414673761",
                                            "type": "redirect",
                                            "dependencies": [],
                                            "dest": "https://www.quicken.com/products/pricing-comparison/?chat=1",
                            ...
                            "policy": "single_experiment",
                            "viewIds": ["25682000707", "25701110939"],
                        ...
                        "audiences": [{
                            ...
                            "id": "20901740234",
                            "name": "Exclude Subscriber Cookie (for New User)",
                            "conditions": ["and", ["or", ["not", ["or", {
                                "match": "exists",
                                "name": "qkn_subscriber",
                                "type": "cookies",
                        ...
                        "views": [{
                            "id": "10707214111",
                            "category": "other",
                            "apiName": "5465611416_confirmation_page__transaction",
                            "name": "Confirmation Page - Transaction",
                            "staticConditions": ["or", ["or", {
                                "match": "simple",
                                "type": "url",
                                "value": "https://www.quicken.com/shoppingcart/confirmation"
                            }]],
                            ...
                            "id": "23089660436",
                            "category": "other",
                            "apiName": "5465611416_any_cart_page",
                            "name": "Any Cart Page",
                            "staticConditions": ["and", ["or", {
                                "match": "substring",
                                "type": "url",
                                "value": "https://quicken.com/shoppingcart"
                            }]],
                            "deactivationEnabled": false,
                            "undoOnDeactivation": false,
                            "tags": []
                            ...
                            "id": "24376380511",
                            "category": "other",
                            "apiName": "5465611416_reverse_nst_for_chat_bot_test",
                            "name": "Reverse NST for Chat Bot Test",
                            "staticConditions": ["and", ["or", {
                                    "match": "simple",
                                    "type": "url",
                                    "value": "https://www.quicken.com/product-selector/reverse-nst&chat=1"
                                }],
                                ["or", {
                                    "type": "custom_code",
                                    "value": function jsCondition() {
                                        return document.cookie.indexOf("Evergreen") !== -1; /*exclude users not test*/
                                    }
                                }]
                            ],
                            "deactivationEnabled": false,
                            ...
                            "id": "25682000707",
                            "category": "other",
                            "apiName": "5465611416_pricing_comparison_for_intercom",
                            "name": "Pricing Comparison for Intercom",
                            "staticConditions": ["and", ["or", {
                                "match": "exact",
                                "type": "url",
                                "value": "https://www.quicken.com/products/pricing-comparison/?chat=1"
                            }]],
                            "deactivationEnabled": false,
                            "undoOnDeactivation": false,
                            "tags": []
                            ...
                            "id": "25701110939",
                            "category": "other",
                            "apiName": "5465611416_pricing_comparison__unrestricted",
                            "name": "Pricing Comparison",
                            "staticConditions": ["and", ["or", {
                                "match": "simple",
                                "type": "url",
                                "value": "https://www.quicken.com/products/pricing-comparison/"
                            }]],
                            "deactivationEnabled": false,
                            "undoOnDeactivation": false,
                            "tags": []
                        ...
                        "events": [{
                            "id": "15165100539",
                            "viewId": null,
                            "name": "New User (clicked 'Create Account')",
                            "category": "other",
                            ...
                            "id": "17043453188",
                            "viewId": null,
                            "name": "Clicked on \"Sign In\" menu item",
                            "category": "other",
                            "apiName": "topnav_signin_menu_item_click",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "17043453195",
                            "viewId": null,
                            "name": "Clicked on \"Support\" menu item",
                            "category": "other",
                            "apiName": "topnav_support_menu_item_click",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "17046501891",
                            "viewId": null,
                            "name": "Clicked on \"Solutions\" menu item",
                            "category": "other",
                            "apiName": "topnav_solutions_menu_item_click",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "17766320810",
                            "viewId": null,
                            "name": "Quicken Survey Popup Clicks (Yes)",
                            "category": "other",
                            "apiName": "quickenSurveyPopupClicks",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "17828330709",
                            "viewId": null,
                            "name": "Quicken Survey Popup Clicks (No)",
                            "category": "other",
                            "apiName": "quickenSurveyPopupClicksNo",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "17844020398",
                            "viewId": null,
                            "name": "Quicken Survey Popup Clicks (Close)",
                            "category": "other",
                            "apiName": "quickenSurveyPopupClicksClose",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "18406710835",
                            "viewId": null,
                            "name": "Home & Business Edition - Win - Buy Now Click (SKU 170166)",
                            "category": "other",
                            "apiName": "home-business-win-buy-now-click_170166",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "18408160447",
                            "viewId": null,
                            "name": "Deluxe Edition - Win - Buy Now Click (SKU 170165)",
                            "category": "other",
                            "apiName": "deluxe-win-buy-now-click_170165",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "18411771016",
                            "viewId": null,
                            "name": "Starter Edition - Win - Buy Now Click (SKU 170163)",
                            "category": "other",
                            "apiName": "starter-win-buy-now-click_170163",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "18412100627",
                            "viewId": null,
                            "name": "Premier Edition - Mac - Buy Now Click (SKU 170164)",
                            "category": "other",
                            "apiName": "premier-mac-buy-now-click_170164",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "18415710586",
                            "viewId": null,
                            "name": "Deluxe Edition - Mac - Buy Now Click (SKU 170165)",
                            "category": "other",
                            "apiName": "deluxe-mac-buy-now-click_170165",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "18417450781",
                            "viewId": null,
                            "name": "Premier Edition - Win - Buy Now Click (SKU 170164)",
                            "category": "other",
                            "apiName": "premier-win-buy-now-click_170164",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "18439560337",
                            "viewId": null,
                            "name": "Starter Edition - Mac - Buy Now Click (SKU 170163)",
                            "category": "other",
                            "apiName": "starter-mac-buy-now-click_170163",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "18651620249",
                            "viewId": null,
                            "name": "Simplifi Cart Add",
                            "category": "other",
                            "apiName": "simplifiCartAdd",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "18805776015",
                            "viewId": null,
                            "name": "Simplifi Buy Now CTA",
                            "category": "other",
                            "apiName": "simplifiBuyNowCta",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "19722600693",
                            "viewId": null,
                            "name": "Example CTA Button Clicks",
                            "category": "other",
                            "apiName": "example-cta-button-clicks",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "19743498901",
                            "viewId": null,
                            "name": "Clicks on ANY of the free trial buttons",
                            "category": "other",
                            "apiName": "ClickOnTryForFree",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "20081615109",
                            "viewId": null,
                            "name": "Exit-intent Popup Trigger",
                            "category": "other",
                            "apiName": "exit_intent_popup",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "20115027977",
                            "viewId": null,
                            "name": "PayPal Checkout Transaction",
                            "category": "other",
                            "apiName": "paypal-checkout-transaction",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "20117176699",
                            "viewId": null,
                            "name": "PayPal Checkout CTA",
                            "category": "other",
                            "apiName": "paypal-checkout-cta",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "20147568005",
                            ...
                            "category": "other",
                            "apiName": "click-buy-now-button",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "20799920745",
                            "viewId": null,
                            "name": "Click outside Upsell popup",
                            "category": "other",
                            "apiName": "outside_upsell_popup",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "22287520616",
                            "viewId": null,
                            "name": "Starter transaction",
                            "category": "other",
                            "apiName": "Starter transaction",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "23350111875",
                            "viewId": null,
                            "name": "Simplifi Monthly Paid transaction",
                            "category": "other",
                            "apiName": "Simplifi Monthly Paid transaction",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "23383232579",
                            "viewId": null,
                            "name": "Premier transaction",
                            "category": "other",
                            "apiName": "Premier transaction",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "23411362266",
                            "viewId": null,
                            "name": "Simplifi Annual Trial transaction",
                            "category": "other",
                            "apiName": "Simplifi Annual Trial transaction",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "23444630226",
                            "viewId": null,
                            "name": "Home and Business transaction",
                            "category": "other",
                            "apiName": "Home and Business transaction",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "23445890153",
                            "viewId": null,
                            "name": "Deluxe transaction",
                            "category": "other",
                            "apiName": "Deluxe transactionn",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "23455660829",
                            "viewId": null,
                            "name": "Simplifi Annual Paid transaction",
                            "category": "other",
                            "apiName": "Simplifi Annual Paid transaction",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "23458080096",
                            "viewId": null,
                            "name": "Simplifi Monthly Trial transaction",
                            "category": "other",
                            "apiName": "Simplifi Monthly Trial transaction",
                            "eventType": "custom",
                            "eventFilter": null
                        }, {
                            "id": "24424310025",
                            "viewId": "24376380511",
                            "name": "Chat Bot Clicks",
                            "category": "other",
                            "apiName": "5465611416_chat_bot_clicks",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-icon-open"
                            }
                        }, {
                            "id": "25124321030",
                            "viewId": "24376380511",
                            "name": "Chat Bot Clicks 5cWdL9MaY9swbfTxuRgNz TdWYCMtBTwFRsiNmk17dR",
                            "category": "other",
                            "apiName": "5465611416_chat_bot_clicks_5cWdL9MaY9swbfT_TdWYCMtBTwFRsiNmk17dR",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-icon-open"
                            ...
                            "id": "25155750686",
                            "viewId": "24376380511",
                            "name": "Chat Bot Clicks 5cWdL9MaY9swbfTxuRgNz",
                            "category": "other",
                            "apiName": "5465611416_chat_bot_clicks_5cWdL9MaY9swbfTxuRgNz",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-icon-open"
                            ...
                            "id": "25165900744",
                            "viewId": "24376380511",
                            "name": "Chat Bot Clicks 5cWdL9MaY9swbfTxuRgNz TdWY UtePLN16pTVsHmjfqLXKy",
                            "category": "other",
                            "apiName": "5465611416_chat_bot_clicks_5cWdL9MaY9swbfT_UtePLN16pTVsHmjfqLXKy",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-icon-open"
                            ...
                            "id": "25215110132",
                            "viewId": "24376380511",
                            "name": "Chat Bot Clicks 5cWdL9MaY9swbfTxuRgNz TdWY 2KpaXSVu3bCGzGYV7WGWi",
                            "category": "other",
                            "apiName": "5465611416_chat_bot_clicks_5cWdL9MaY9swbfT_2KpaXSVu3bCGzGYV7WGWi",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-icon-open"
                            ...
                            "id": "25228880840",
                            "viewId": "24376380511",
                            "name": "Click Event for .intercom-lightweight-app-launcher-custom-icon-open",
                            "category": "other",
                            "apiName": "5465611416_click_event_for_intercomlightweightapplaunchercustomi",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-custom-icon-open"
                            }
                        }, {
                            "id": "25250011691",
                            "viewId": "24376380511",
                            "name": "Questions tab",
                            "category": "other",
                            "apiName": "5465611416_questions_tab",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".tab"
                            ...
                            "id": "25251271108",
                            "viewId": "24376380511",
                            "name": "Click Event for .e1ii8mwa0",
                            "category": "other",
                            "apiName": "5465611416_click_event_for_e1ii8mwa0",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".e1ii8mwa0"
                            ...
                            "id": "25261291379",
                            "viewId": "24376380511",
                            "name": "Chat Bot Clicks 5cWdL9MaY9swbfTxuRgNz TdWY KCPnKhF8ydosJFgt8Kypr",
                            "category": "other",
                            "apiName": "5465611416_chat_bot_clicks_5cWdL9MaY9swbfT_KCPnKhF8ydosJFgt8Kypr",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-icon-open"
                            ...
                            "id": "25281481423",
                            "viewId": "24376380511",
                            "name": "Chat Bot Clicks QbH1v3iGG1H28vMkFUVqa",
                            "category": "other",
                            "apiName": "5465611416_chat_bot_clicks_QbH1v3iGG1H28vMkFUVqa",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-icon-open"
                            ...
                            "id": "25291671167",
                            "viewId": "24376380511",
                            "name": "Click Event for .intercom-lightweight-app- 5GQg9jjfRoxdZ4zCTpqWW",
                            "category": "other",
                            "apiName": "5465611416_click_event_for_intercomlightwe_5GQg9jjfRoxdZ4zCTpqWW",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-custom-icon-open"
                            ...
                            "id": "25358410307",
                            "viewId": "24376380511",
                            "name": "Chat Bot Clicks 5cWdL9MaY9swbfTxuRgNz FWtw UqXLPBS1DGKRm6omHi7nm",
                            "category": "other",
                            "apiName": "5465611416_chat_bot_clicks_5cWdL9MaY9swbfT_UqXLPBS1DGKRm6omHi7nm",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-icon-open"
                            ...
                            "id": "25364210072",
                            "viewId": "24376380511",
                            "name": "Click Event for .e1ii8mwa0 B5NCmhBmoR9B3p7fU8c1H",
                            "category": "other",
                            "apiName": "5465611416_click_event_for_e1ii8mwa0_B5NCmhBmoR9B3p7fU8c1H",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".e1ii8mwa0"
                            ...
                            "id": "25668680725",
                            "viewId": "24376380511",
                            "name": "Chat Bot Clicks DNG3q9BwCAVKUEdsDzwhP",
                            "category": "other",
                            "apiName": "5465611416_chat_bot_clicks_DNG3q9BwCAVKUEdsDzwhP",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-icon-open"
                            ...
                            "id": "25683641034",
                            "viewId": "24376380511",
                            "name": "Click Event for .e1ii8mwa0 NvBoFtkrh9KiNeYcqQvZT",
                            "category": "other",
                            "apiName": "5465611416_click_event_for_e1ii8mwa0_NvBoFtkrh9KiNeYcqQvZT",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".e1ii8mwa0"
                            ...
                            "id": "25686150930",
                            "viewId": "24376380511",
                            "name": "Click Event for .intercom-lightweight-app- 59tBX5za59cez6QvEZJU2",
                            "category": "other",
                            "apiName": "5465611416_click_event_for_intercomlightwe_59tBX5za59cez6QvEZJU2",
                            "eventType": "click",
                            "eventFilter": {
                                "filterType": "target_selector",
                                "selector": ".intercom-lightweight-app-launcher-custom-icon-open"
                        ...
                        "dimensions": [{
                            ...
                            "id": "15149220286",
                            "name": "New User (clicked Create Account) - Simplifying Payment Test",
                            "apiName": "create_account",
                            "segmentId": null
                        }],
                        "projectJS": function() { // ensures the optimizely object is defined globally
                            ...
                            window.optimizely.push({
                                ...
                                "canonicalOrigins": ["simplifimoney.com", "www.simplifimoney.com", "stg.simplifimoney.com"]
                            });
                        },
                        "plugins": [function(PluginManager) {

                            PluginManager.registerAnalyticsTracker('20224875649', {
                                preRedirectPolicy: 'PERSIST_BEFORE_REDIRECT',
                                postRedirectPolicy: 'TRACK_IMMEDIATELY',
                                nonRedirectPolicy: 'TRACK_IMMEDIATELY',
                                trackLayerDecision: function(decisionData) {
                                    var extension = decisionData.integrationSettings && decisionData.integrationSettings['20224875649'];
                                    if (!extension) {
                                        return;
                                    }
                                    var campaign = {
                ...
                if (f.initGlobalStore(s), u.populateDirectiveData(), r.clientHasAlreadyInitialized()) e.warn("Main / Disabling because Optimizely has already initialized on this page load. Are there multiple snippets on the page?");
                    ...
                    if (r.shouldLoadInnie()) a.registerFunction("getProjectId", (function() {
                        ...
                        return s.projectId
                    })), c.addScriptSync("https://cdn-assets-prod.s3.amazonaws.com/js/preview2/5465611416.js"));
